    ...
    t && Object.deepExtend(i, t), i.tmp.obj = {
        ...
        if (i.interactivity.events.onhover.enable && isInArray("bubble", i.interactivity.events.onhover.mode)) {
            ...
            function p(t, a, s, n, r) {
                if (t != a)
                    if (i.tmp.bubble_duration_end) void 0 != s && (o = t + (t - (n - v * (n - t) / i.interactivity.modes.bubble.duration)), "size" == r && (e.radius_bubble = o), "opacity" == r && (e.opacity_bubble = o));
...
Object.deepExtend = function e(t, a) {
    for (var i in a) a[i] && a[i].constructor && a[i].constructor === Object ? (t[i] = t[i] || {}, e(t[i], a[i])) : t[i] = a[i];
    return t
